...
#labels=(1NJQ_c27)
labels=(9-md_1000ns_A 9-md_1000ns_2_A 9-md_1000ns_3_A)
...
echo -e "25\n20" | gmx_mpi trjconv -s $pdb -f $xtc -fit rot+trans -o traj_fitted.xtc -n $ndx
echo "20" | gmx_mpi trjconv -s $pdb -f traj_fitted.xtc -o traj_cf_part.xtc -split $partsl -n $ndx
# 7: for each one:
...
EOF
	...
	echo -e "25\n21" | gmx_mpi trjconv -f $xtcpart -s $pdb -fit rot+trans -o $xtcpartfit -n $ndx
