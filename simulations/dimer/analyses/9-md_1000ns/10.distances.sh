...
gmx_mpi pairdist -f ../traj_centered_prot_MG_B.xtc -s ../sim_prot_MG_B.tpr -n index_distB.ndx -ref -sel -refgrouping res -selgrouping res -o dist_K331.Q73_K331.R80.xvg <<eof
14
15
16
eof
