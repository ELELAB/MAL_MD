...
$path_gmx trjconv -f traj_centered_prot_MG_A.xtc -s sim_prot_MG_A.tpr -fit rot+trans -dt 5000 -o movie.dt5000_A.pdb <<eof
3
1
eof
$path_gmx trjconv -f traj_centered_prot_MG_B.xtc -s sim_prot_MG_B.tpr -fit rot+trans -dt 5000 -o movie.dt5000_B.pdb <<eof
3
1
eof
